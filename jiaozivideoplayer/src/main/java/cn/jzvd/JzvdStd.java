...
public class JzvdStd extends Jzvd {
    ...
    public void setSize(int size) {
        this.size = size;
        if (dialog!=null&&DialogUtils.textView!=null)
        {
            DialogUtils.textView.setText(DialogUtils.textView.getText().toString().replace("0",size+""));
        }
    }
    ...
    public void setClickListener(OnClickListener clickListener) {
        ...
        if (dialog == null)
        {
            dialog = DialogUtils.isWIFIDialog(getContext(),clickListener);
    ...
    public void setUp(JZDataSource jzDataSource, int screen) {
        ...
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN||currentScreen == SCREEN_WINDOW_NORMAL) {
...
//        builder.create().show();
    ...
    public void updateStartImage() {
        if (currentState == CURRENT_STATE_PLAYING) {
            ...
            bottom_play.setImageResource(R.drawable.stop);
    ...
    public void showWifi() {
        if (dialog != null&&!isDialogShow) {
            isDialogShow = true;
            if (currentState == CURRENT_STATE_PLAYING || currentState == CURRENT_STATE_PAUSE||currentState == CURRENT_STATE_NORMAL)
            {
                JZMediaManager.instance().releaseMediaPlayer();
                JzvdMgr.completeAll();
                seekToInAdvance = getCurrentPositionWhenPlaying();
            }
            dialog.show();
        }
