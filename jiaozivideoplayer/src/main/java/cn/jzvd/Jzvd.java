...
public abstract class Jzvd extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public ImageView myStart;// 自定义的开始按钮。只是用于第一次启动。

    public SeekBar progressBar;
    public ImageView fullscreenButton;
    public TextView currentTimeTextView, totalTimeTextView;
    public static ViewGroup textureViewContainer;
    ...
    public static ImageView myShare;
    public static TextView cut_voice;
    public static boolean isShowCut = false;
    public static boolean isShowShare = false;
    public static OnClickListener clickListener = null;
    ...
    public static boolean backPress() {
        ...
        if (JzvdMgr.getSecondFloor() != null) {
            ...
            if (JzvdMgr.getFirstFloor().jzDataSource.containsTheUrl(JZMediaManager.getDataSource().getCurrentUrl())) {
                Log.i(TAG, "3333333333333333333333331");
                ...
                if (isShowShare || isShowCut) {
                    cut_voice = JzvdMgr.getFirstFloor().findViewById(R.id.jz_cut_voice);
                    myShare = JzvdMgr.getFirstFloor().findViewById(R.id.jz_share);
                    textureViewContainer = JzvdMgr.getFirstFloor().findViewById(R.id.surface_container);
                }


                if (isShowShare)
                {
                    myShare.setVisibility(VISIBLE);
                    myShare.setOnClickListener(clickListener);
                }

                if (isShowCut)
                {
                    cut_voice.setVisibility(VISIBLE);
                    cut_voice.setOnClickListener(clickListener);
                    cut_voice.performClick();
...
//                JZVideoPlayer.releaseAllVideos();
    ...
    public void init(Context context) {
        ...
        myShare = findViewById(R.id.jz_share);
        cut_voice = findViewById(R.id.jz_cut_voice);
        bottom_play = findViewById(R.id.bottom_play);
        myStart = findViewById(R.id.mystart);
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.start||i == R.id.bottom_play) {
            ...
            if (currentState == CURRENT_STATE_NORMAL) {
                ...
                JZMediaManager.pause();
                onStatePause();
            } else if (currentState == CURRENT_STATE_PAUSE || currentState == CURRENT_STATE_AUTO_COMPLETE) {
...
//                        mDownY = y;
    ...
    public void startVideo() {
        ...
        if (isShowCut)
        {
            cut_voice.setVisibility(View.VISIBLE);
        }
