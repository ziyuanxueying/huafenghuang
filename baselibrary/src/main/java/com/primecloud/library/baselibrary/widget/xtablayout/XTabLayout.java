package com.primecloud.library.baselibrary.widget.xtablayout;
...
public class XTabLayout extends HorizontalScrollView {
    ...
    public interface OnTabSelectedListener {
         ...
         * may use this action to return_back to the top level of a category.
         *
...
//        invalidate();
    ...
    public static final class Tab {
        ...
        /**
         * return_back the icon associated with this tab.
         *
        ...
        /**
         * return_back the current position of this tab in the action bar.
         *
        ...
        /**
         * return_back the text of this tab.
         *
...
//                        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (targetView == null) {
                // If we don't have a view, just update the position now and return_back
                updateIndicatorPosition();
                return;
            }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        ...
        // We return_back the default layout params so that we don't blow up if we're given a TabItem
