...
public class SettingBar extends FrameLayout {
    ...
    public SettingBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCenterView = (TextView) findViewById(R.id.tv_setting_bar_center);
        ...
        if(array.hasValue(R.styleable.SettingBar_bar_centerText)){
            setCenterText(array.getString(R.styleable.SettingBar_bar_centerText));
        }

        if(array.hasValue(R.styleable.SettingBar_bar_centerVisible)){
            setCenterVisible(array.getBoolean(R.styleable.SettingBar_bar_centerVisible, false));
        }
        ...
        if(array.hasValue(R.styleable.SettingBar_bar_centerHint)){
            setCenterHint(array.getString(R.styleable.SettingBar_bar_centerHint));
        }
        ...
        if(array.hasValue(R.styleable.SettingBar_bar_centerColor)){
            setCenterColor(array.getColor(R.styleable.SettingBar_bar_centerColor,0));
        }
        ...
        if(array.hasValue(R.styleable.SettingBar_bar_centerSize)){
            setCenterSize(TypedValue.COMPLEX_UNIT_PX ,array.getDimensionPixelSize(R.styleable.SettingBar_bar_centerSize, 0 ));
        }
        // 分割线设置
     ...
     * 设置中间的文本
     */
    public void setCenter(int stringId){
        mCenterView.setVisibility(View.VISIBLE);
        setCenterText(getResources().getString(stringId));
    }
    public void setCenterText(CharSequence centerText){
        mCenterView.setText(centerText);
    }
    /**
     * 设置右边的提示
     */
    ...
    public void setCenterHint(int stringId) {
        setCenterHint(getResources().getString(stringId));
    }

    public void setCenterHint(CharSequence hint) {
        mCenterView.setVisibility(View.VISIBLE);
        mCenterView.setHint(hint);
    }
     ...
     * 设置中间文本大小
     */
    public void  setCenterSize(int unit,float size){
